...
public interface UserRepository extends Neo4jRepository<User, Long> {
    ...
    Collection<Experience> getAllUserStudyExperiences(Long id);
    ...
    Collection<Experience> getAllUserWorkSchoolExperiences(Long id);
    ...
    Collection<Experience> getAllUserWorkCompanyExperiences(Long id);
